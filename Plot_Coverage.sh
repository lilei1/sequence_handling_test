...
SAMPLE_INFO=${HOME}/Deleterious_mutation_project/mapping_sample/wild_accs_bam/Barley/SAM_Processing/Genetics/Coverage_Map/Genetics_samples_coverage.txt

#   Name of Project
PROJECT=Barley

#   Scratch directory for output, 'scratch' is a symlink to individual user scratch at /scratch*
SCRATCH=${HOME}/Deleterious_mutation_project/mapping_sample/wild_accs_bam/Barley/SAM_Processing/Genetics/
