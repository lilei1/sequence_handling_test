...
SEQUENCE_HANDLING=${HOME}/sequence_handling

#   List of samples to be processed
SAMPLE_INFO=${HOME}/Deleterious_mutation_project/mapping_sample/sample_infor
...
FORWARD_NAMING=_R1.fastq
REVERSE_NAMING=_R2.fastq

#   Project name
PROJECT=Barley

#   Output directory
SCRATCH=${HOME}/Deleterious_mutation_project/mapping_sample

#   Adapters file
ADAPTERS=${HOME}/Shared/shared/Software/scythe/illumina_adapters.fa
